#!/usr/bin/env python
"""Calibrate graph_queries difficulty targeting and suite quota coverage."""
...
app = typer.Typer(help="Calibrate graph_queries difficulty targeting.")
    ...
    *,
    ...
    for difficulty in DIFFICULTIES:
        ...
        for _ in range(samples):
            ...
            task = generate_graph_queries_task(axes=axes, rng=rng)
            if task.difficulty is None:
                raise RuntimeError(
                    "graph_queries task produced None difficulty "
                    "during calibration"
                )

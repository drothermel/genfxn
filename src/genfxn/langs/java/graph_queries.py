...
def render_graph_queries(
    ...
    lines.extend(
        [
            ...
            "        long key = (((long) rawU) << 32) ^ (rawV & 0xFFFF_FFFFL);",
            ...
            "    }",
            "",
            "    java.util.ArrayList<java.util.ArrayList<long[]>> "
            "adjacency = new java.util.ArrayList<>();",
            ...
            "        int u = (int) (key >> 32);",
            "        int v = (int) key;",
            "        adjacency.get(u).add(new long[] {v, entry.getValue()});",
            "    }",
            ...
            "                return 1;",
            "            }",
            "            for (long[] pair : adjacency.get(node)) {",

...
def render_graph_queries(
    ...
    lines.extend(
        [
            ...
            "    }",
            "",
            "    let mut best_cost: Vec<Option<i64>> = vec![None; n_nodes];",
            "    let mut frontier: Vec<usize> = vec![src_idx];",
            "    best_cost[src_idx] = Some(0);",
            "    while !frontier.is_empty() {",
            "        let mut best_idx = 0usize;",
            "        let mut best_node = frontier[0];",
            "        let mut best_pair = (best_cost[best_node].unwrap_or(0), "
            "best_node);",
            "        for i in 1..frontier.len() {",
            "            let candidate_node = frontier[i];",
            "            let candidate_pair = (",
            "                best_cost[candidate_node].unwrap_or(0),",
            "                candidate_node,",
            "            );",
            ...
            "        }",
            "",
            "        let node = frontier[best_idx];",
            "        let cost = best_cost[node].unwrap_or(0);",
            "        let last_idx = frontier.len() - 1;",
            "        frontier[best_idx] = frontier[last_idx];",
            "        frontier.pop();",
            "        if node == dst_idx {",
            "            return cost;",
            "        }",
            ...
            "            if let Some(prev) = best_cost[neighbor] {",
            "                if next_cost >= prev {",
            "                    continue;",
            "                }",
